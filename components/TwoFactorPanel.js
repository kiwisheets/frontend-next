...
const ENABLE_TWO_FACTOR = gql`
  mutation enableTwoFactor($secret: String!, $token: String!) {
    enableTwoFactor(secret: $secret, token: $token)
  }
`;
...
const TwoFactorPanel = (props) => {
  ...
  const [
    enableTwoFactor,
    { loading: enableTwoFactorLoading, error: enableTwoFactorError },
  ...
  const [
    disableTwoFactor,
    { loading: disableTwoFactorLoading, error: disableTwoFactorError },
          ...
          <Fade in>
            ...
            >
              <Grid item sm={8}>
                ...
                <Typography variant="body2">
                  Remember that this reduces the security of your account, so
                  please be sure you wish to continue
                </Typography>
              </Grid>
              <Grid item sm={4}>
          ...
          <Grid container>
            <Grid item sm={4}>
              <Grid container>
                <Grid item sm={12}>
                  <Typography variant="body2">
                    <strong>1.</strong> Scan the QR Code displayed in an app
                    like{' '}
                    <Link
            ...
            <Grid item sm={4}>
              <Grid container>
                ...
                <Grid item sm={12}>
                  <Typography variant="caption">Secret: {secret}</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item sm={4}>
              <Grid container spacing={3} justify="space-around">
                <Grid item sm={12}>
                  <Typography variant="body2" gutterBottom>
                    <strong>2.</strong> Then type the time based code displayed
                    in the app here and click save
                  </Typography>
                </Grid>
                <Grid item sm={12}>
